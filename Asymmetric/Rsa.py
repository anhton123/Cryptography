...
def rsa_encrypt(txt, p, q):
    ...
    Returns:
        tuple (string value of encrypted text, list of char values of encrypted txt, String representing key values): \
...
# print(rsa_encrypt("asdfasdfasdf", 23, 31))
# print(rsa_decrypt("['~', 'æ', 'ȃ', 'Ì', '~', 'æ', 'ȃ', 'Ì', '~', 'æ', 'ȃ', 'Ì']", 3547, 713))
