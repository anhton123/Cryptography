def encrypt(isFile, input, privKey, pubKey):
    """Symmetric DES encryption algorithim
    ...
    Returns:
        str: returns the cipher text of input using DES encryption algorithim
    """
    pass

def decrypt(isFile, input, privKey, pubKey):
    """Symmetric DES decryption algorithim
    ...
    Returns:
        str: returns the original text of input using DES decryption algorithim
    """
    pass