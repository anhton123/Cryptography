def encrypt(isFile, input, privKey, pubKey):
    """Symmetric ROT13 encryption algorithim
    ...
    Returns:
        str: returns the cipher text of input using ROT13 encryption algorithim
    """
    pass
...
def decrypt(isFile, input, privKey, pubKey):
    ...
    Returns:
        str: returns the original text of input using ROT13 decryption algorithim
    """
    pass